// frontend/components/space/materials/SaturnMaterial.tsx
'use client';
...
/*
  SaturnMaterial: Procedural soft beige banded appearance (no textures).
  Designed to pair with a separate ring mesh.
*/
