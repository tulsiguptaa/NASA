...
/*
  VenusMaterial: Procedural cloudy yellowish appearance
  - Simulates Venus's thick atmosphere with swirling patterns
*/
...
const fragmentShader = /* glsl */ `
  ...
  void main() {
    ...
    // Add some variation to the cloud patterns
    ...
    // Create base color with cloud variations
    vec3 col = mix(uBase, uCloud, clouds);
    
    // Add highlights for some areas
