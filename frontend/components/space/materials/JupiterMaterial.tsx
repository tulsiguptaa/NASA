// frontend/components/space/materials/JupiterMaterial.tsx
'use client';
...
/*
  JupiterMaterial: Procedural banded gas giant with a Great Red Spot-like storm.
...
const fshader = /* glsl */ `
  ...
  void main(){
    ...
    // Banded base pattern with some turbulent warping
...
export function JupiterMaterial(){
  ...
  const uniforms = useMemo(() => ({
    uTime: { value: 0 },
    uDark:  { value: new THREE.Color('#8c6d4d') },  // darker brown
    uMid:   { value: new THREE.Color('#caa27f') },  // mid tan
    uLight: { value: new THREE.Color('#e6d1b8') },  // light cream
    uSpot:  { value: new THREE.Color('#c15c2a') },  // red spot
  }), []);
